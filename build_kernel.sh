...
# AirTies AIR 7310T — AirTies- project
#
...
grep -n 'AirTies-' drivers/net/ethernet/broadcom/genet/bcmmii.c
...
grep -n 'AirTies-' drivers/net/ethernet/broadcom/genet/bcmgenet.c
...
# === AirTies- BCM7231 — Minimal config overrides ===
